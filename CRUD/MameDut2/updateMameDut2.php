...
if(isset($_POST["id"]) && !empty($_POST["id"])){
    ...
    if(empty($input_niveau)){
        $username_err = "Please enter the niveau amount.";     
    }  else{
        $niveau = $input_niveau;
    }
    ...
    if(empty($name_err) && empty($prenom_err) && empty($username_err)){
        ...
        $sql = "UPDATE employees SET name=:name, prenom=:prenom, username=:username, niveau=:niveau WHERE id=:id";
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form action="<?php echo htmlspecialchars(basename($_SERVER['REQUEST_URI'])); ?>" method="post">
                        ...
                        <div class="form-group">
                            <label>Address</label>
                            <textarea name="prenom" class="form-control <?php echo (!empty($prenom_err)) ? 'is-invalid' : ''; ?>"><?php echo $address; ?></textarea>
                        ...
                        <div class="form-group">
                            <label>Niveau</label>
                            <input type="text" name="niveau" class="form-control <?php echo (!empty($username_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $salary; ?>">
                            <span class="invalid-feedback"><?php echo $username_err;?></span>
                        </div>
